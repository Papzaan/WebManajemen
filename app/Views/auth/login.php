                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="/auth/valid_login">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="email" aria-describedby="emailHelp" placeholder="Masukan Alamat Email...">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        Belum Punya Akun? <a class="small" href="/auth/register">Klik Disini!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
