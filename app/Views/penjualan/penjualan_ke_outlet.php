...
<div class="container-fluid">
    ...
    <div class='box box-primary'>
        <div class='box-header  with-border'>
            <h3 class='box-title'>Penjualan Produk Ke Outlet</h3>
        </div>
        <div>
            <?php echo session()->getFlashdata('stok_habis'); ?>
        </div>
        <div class="box-body">
            <form class="user" method="post" action="/penjualan/input_penjualan_ke_outlet">
                    ...
                    <div class="form-group">Nama Barang</label>
                        ...
                        <select class="form-control" id="nama_kategori" name="nama_kategori" onChange="update_harga()">
                            ...
                            <?php foreach ($kategori as $kr) { ?>
                                <option id="<?php echo $kr["harga_outlet"]; ?>" value="<?php echo $kr["nama_kategori"]; ?>">
