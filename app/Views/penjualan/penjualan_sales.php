...
<div class="container-fluid">
    ...
    <div class='box box-primary'>
        ...
        <div class="box-body">
            <form class="user" method="post" action="/penjualan/input_penjualan_sales">
                <div class="form-group">
                        ...
                        <div class="col-sm-5 mb-3 mb-sm-0">
                            ...
                            <select class="form-control theSelect" id="nama_cus" name="nama_cus" onChange="update_nik()">
                                ...
                                <?php foreach ($nama_cus as $kr) { ?>
                                    <option id="<?php echo $kr["no_telp_customer_sal"]; ?>" value="<?php echo $kr["nama_cussal"]; ?>">
                                        <?php echo $kr["nama_cussal"]; ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <!-- mbatas option -->
                    ...
                    <div class="box-footer">
                        ...
                        <a href="/penjualan/laporan_sales" class="btn btn-default ">Cancel</a>
                    </div>
            </form>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
