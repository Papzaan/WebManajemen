...
<?php foreach ($barang as $d) { ?>
    ...
    <label for="ukuran" class="control-label">Tambah</label>
                    ...
                    <div class="input-group">
                        <input type="text" name="jumlah_tambah" id="jumlah_tambah"  data-error="harga harus di isi" placeholder="Tambah Barang" class="form-control" required>
                        <span class="input-group-addon">
                        </span>
                    </div>
    </div>
...
<?php foreach ($barang as $d) { ?>
    ...
    <label for="ukuran" class="control-label">Kurang</label>
                    ...
                    <div class="input-group">
                        <input type="text" name="jumlah_tambah" id="jumlah_tambah"  data-error="harga harus di isi" placeholder="Kurang Barang" class="form-control" required>
                        <span class="input-group-addon">
                        </span>
                    </div>
    </div>
